...
<div style="background-color: #FFFFCC; padding: 10px;"> 
As we can see from the above plot, the thick blue line does indicate that the overall tourist trips have increased over the years, especially after 2010. However, it we look at the quarter lines themselves, we notice that the teal colored line is way higher than the rest. Could this be due to __the quarter being a either spring or winter where whale sharks are prominent as depicted  from our previous analysis on the sightings by seasons__.
</div>
