...
The @fig-countoccur below depict the number of occurence for every season from 1993 until 2023.
```{r}
...
whale_shark %>% na.omit() %>%
  ...
  coord_flip() +
  ggtitle(label = "Sightings East v/s West season wise",
            subtitle = "Data Period: 1993 - 2023") +
  xlab("Seasons") +
  ylab("Sightings") +
  theme_classic() +
...
whale_shark_weather <- whale_shark %>%
                         # Filter occurence to near learmonth weather station
