...
author: "AMICA - Evan Hadinata Ginting & Harsh Jain"
format: html
---
...
```{r IDA2}
#| label: fig-boxplot
#| fig-cap: "Profile of Yearly Occurences"
#| fig-width: 8
#| fig-heigth: 8
#| echo: true
#| warning: false
...
ws_raw %>% 
  ...
  geom_boxplot() +
  ggtitle(label = "Profile of Yearly Occurences") +
...
### Expectation 1: We expect to observe seasonal patterns in whale shark sightings, with higher occurrences during winter months. The @fig-countoccur below depict the number of occurence for every season from 1993 until 2023.
...
whale_shark %>%
  ...
  ggplot(aes(x = fct_reorder(season, -count), y = count)) +
    ...
    geom_text(aes(label = count, x = season, y = count),
                              ...
                              hjust = 0.5,
                              size = 4) +
    ggtitle(label = "Number of Occurences per Season",
...
```{r}
#| label: fig-aumap
#| fig-cap: "Locations of Where Sightings are Recorded"
#| fig-width: 10
#| fig-heigth: 8
#| echo: true
#| warning: false
