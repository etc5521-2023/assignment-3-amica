...
ggplot(highest_sightings, aes(x = year_quarter, y = total_trips, color = total_trips)) +
  geom_point() +
  labs(title = "Scatterplot of year_quarter vs total_trips",
       x = "Year Quarter",
       y = "Total Trips in a Quarter") +
  theme_classic()
...
scags_res <- scagnostics(highest_sightings$year_quarter, highest_sightings$total_trips)
print(scags_res)
...
ggplot(exmouth_2010) +
  ...
  geom_line(aes(x = year_quarter, y = total_trips, color = "Trips", group=1), size = 0.5) +
