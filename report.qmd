...
pt_sf <-
  st_join(t_region, whale_shark_sf, left = FALSE) %>%  # spatial join to get intersection of points and poly
...
- A significant observation is the continual increase in tourists visiting Exmouth for holidays, highlighting its growing status as a favored vacation spot.

- Tourism attracts a significantly larger number of visitors compared to business travelers and other visitors.
...
**Overall tourism trends in Exmouth**

- The visualization displays the total tourist visits annually in the Exmouth region.

- Two significant observations can be made from the plot: 

    - Firstly, there is frequent fluctuation in the average number of trips throughout the year, possibly influenced by the quarter.
    
    - Secondly, the peaks of the trips appear to be more prominent in the second half of the plot, suggesting a particular trend in the tourist visits over the years.


**But is this actually the case?** 

**Let's visualize the number of trips in a different way to see how the trips fared overall throughout the years.**
...
- Observing the individual quarter lines, it becomes apparent that the teal colored line is significantly higher than the others.

- This could potentially be attributed to the particular quarter being either spring or winter, a time when whale sharks are prominent, as previously depicted in our analysis of sightings by seasons.
...
- Exmouth's tourism demonstrates notable seasonal patterns, with the peak seasons identified as July and October, supported by weather data showing relatively mild conditions even during winter.

- The favorable climate allows for various outdoor activities like swimming, observing marine life, and enjoying the wildflower season.

- These factors contribute to the highest tourist numbers in Q3, followed by a slight decline in Q4, while Q1 experiences a decrease, marking the off-peak season for tourism.

- Recent years have seen a consistent rise in tourism in Exmouth, with the peak observed in 2021 Q3, as indicated by the overall upward trend in the tourism region data and the seasonal trend analysis.

- The fluctuation in the remainder plot has increased, suggesting that factors beyond seasonal variations, such as promotional activities, local events, policy changes, or other tourism-related influences, play a significant role in the number of tourists.
...
**Due to severe missing data before 2010, our focus is on 2010-2023.**
...
- Travel trends in Exmouth highlight a preference for visiting between Q2 and Q4, with Q3 being the peak season for sightseeing, as indicated in the seasonal trend analysis.

- Despite the impact of the COVID-19 pandemic on global tourism, the successful year of 2021 for tourism in Australia suggests a potential recovery in the sector.

- The launch of the COVID-19 vaccination program by the Australian Government in December 2020 likely played a role in increasing travelers' confidence, leading to a willingness to travel post-vaccination.
...
In next section, we combine the weather, previous traveler information and Whale Shark data to determine if any correlations exist among them.
