...
```{r}
ggplot(weather_tourism_exmouth_2010, aes(x = year_quarter)) +
  geom_line(aes(y = total_trips, color = "Total Trips"), linetype = "solid") +
  geom_smooth(aes(y = avg_temp, linetype = "Avg Temp"), color = "darkgreen", fill = "darkgreen") +
  geom_smooth(aes(y = mean_prcp, linetype = "Mean Precip"), color = "lightblue", fill = "lightblue") +
  labs(color = "Data", fill = "Data") +
  theme_bw()
